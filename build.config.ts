...
/**
 * Library build: the importable API. Three entries, one bundle each, into
 * `dist/` — which holds the library alone.
 *
...
export default defineBuildConfig({
  entries: [
    {
      type: "bundle",
      input: ["./src/index.ts", "./src/components/index.ts", "./src/agent/index.ts"],
