...
Local (wllama) runs llama.cpp compiled to WebAssembly in a Worker in the current tab. The
default loader imports wllama from jsDelivr, loads its wasm, and downloads public GGUF
