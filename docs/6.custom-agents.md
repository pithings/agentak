...
| `setPickerOpen`    | Let the session control the provider picker.      |
...
then controls whether the picker is open.

If you leave out `providers`, the picker can show one model list under `providerLabel`. If
