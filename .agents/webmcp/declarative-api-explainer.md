...
However, not all site functionality is exposed via JavaScript functions, and features that _are_
...
TODO: The exact algorithms reducing a form, its form-associated elements, and _their_ attributes
...
When the form element does _NOT_ perform a navigation, JavaScript can hand-craft the response to the
...
It is TBD how _declarative_ WebMCP tools will be exposed to any interface that exposes a site's
