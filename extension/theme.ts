 ...
 * call, not the library's — a page may run a theme switch of its own. The panel
 * has no switch and needs none, so it follows the browser, and keeps following
 * it: `prefers-color-scheme` changes under a panel
