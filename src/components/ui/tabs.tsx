...
const S = {
  ...
  tab: {
    ...
    outline: "none",
    transition:
      "background-color var(--wa-transition), border-color var(--wa-transition), color var(--wa-transition)",
    border: "1px solid transparent",
    borderRadius: "var(--wa-radius-md)",
    padding: "0.25rem 0.5rem",
    color: "var(--wa-muted-foreground)",
  },
  tabHover: { color: "var(--wa-foreground)" },
  tabFocus: { borderColor: "var(--wa-ring)", boxShadow: "var(--wa-focus-ring)" },
