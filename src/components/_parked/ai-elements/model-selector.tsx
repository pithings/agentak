...
const S = {
  ...
  // The same cap `CommandList` carries, and the same variable behind it, so a
  // keyboard takes this one off too — writing a plain height here would put the
  // cap back on and pin the list short over a keyboard. See `ui/command.tsx`.
  modelSelectorList: { maxHeight: "var(--command-room, 18rem)" },
